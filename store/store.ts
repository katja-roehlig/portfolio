  ...
  state: () => ({
    projects: [
      <projectStructure>{
        ...
        tabletImg: "url(src/assets/Tictactoe_Tablet.webp)",
        desktopImg: "url(src/assets/Tictactoe_desktop.webp)",
      ...
      <projectStructure>{
        ...
        tabletImg: "url(src/assets/Shopping_Tablet.webp)",
        desktopImg: "",
        text1:
      ...
      <projectStructure>{
        ...
        tabletImg: "url(src/assets/Birthday_Tablet.webp)",
        desktopImg: "url(src/assets/Birthday_Desktop.webp)",
